...
public class ArticleController {
    ...
    @GetMapping
    public ArticleQueryResponse query(@Valid @ModelAttribute ArticleQueryRequest request) {
    ...
    @PostMapping
    public ArticleSaveResponse save(@Valid @RequestBody ArticleSaveRequest request) {
        String id = articleService.save(request);
        return ArticleSaveResponse.builder().id(id).build();
    }

    @PutMapping("/{id}")
    public void update(@PathVariable("id") String id, @Valid @RequestBody ArticleUpdateRequest request) {
