...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, CategoryViewEvent> categoryViewConsumerFactory() {
        ...
        JsonDeserializer<CategoryViewEvent> deserializer = new JsonDeserializer<>(CategoryViewEvent.class, mapper, false);
        deserializer.addTrustedPackages("*");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CategoryViewEvent> categoryViewConcurrentKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, CategoryViewEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(categoryViewConsumerFactory());
        return factory;
    }
